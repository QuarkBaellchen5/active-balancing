...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=ACPL-K30T_DC.dat>
  <DataDisplay=ACPL-K30T_DC.dpl>
  <OpenDisplay=0>
  <Script=ACPL-K30T_DC.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <SPICEINIT SPICEINIT1 1 110 610 -30 16 0 0 "set ngbehavior=ltps" 1>
  <R R1 1 420 250 15 -26 0 1 "10MEG" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "US" 0>
...
<Diagrams>
  <Rect 550 574 461 414 3 #c0c0c0 1 00 1 0 0.002 0.02 0 0 1 8 1 -1 0.2 1 315 0 225 1 0 0 "" "" "">
