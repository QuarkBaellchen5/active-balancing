...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=PVI5050N_TRAN.dat>
  <DataDisplay=PVI5050N_TRAN.dpl>
  <OpenDisplay=0>
  <Script=PVI5050N_TRAN.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <Sub SUB1 1 260 230 -76 -105 0 0 "PVI5050N_sub.sch" 1>
  ...
  <Irect I1 1 100 250 -99 -26 1 1 "20 mA" 1 "2 ms" 1 "5 ms" 1 "100 ns" 1 "100 ns" 1 "1 ms" 1>
...
<Wires>
  ...
  <340 200 420 200 "Vout" 390 160 56 "">
</Wires>
<Diagrams>
  <Rect 550 574 461 414 3 #c0c0c0 1 00 1 0 0.001 0.01 1 -0.507934 1 5.57968 1 -1 0.2 1 315 0 225 1 0 0 "" "" "">
